...
public class IUPerfilMembro extends javax.swing.JDialog {
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        m.setNome(username.getText());
        m.setEmail(useremail.getText());
        m.setTelefone(userphone.getText());
        m.setEndereco(useraddress.getText());
        if (userpass.getText().length() > 0) {
            m.setSenha(newpass.getText());
        }
        m.setCategoriaAlimentar(catalim.getSelectedItem().toString());
